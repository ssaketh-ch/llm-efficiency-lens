#!/bin/bash
#SBATCH --job-name=gemma4_31b_sweep
...
log() { echo "[$(date '+%Y-%m-%d %H:%M:%S')] $1" | tee -a ~/quantization/results/throughput/logs/sweep_gemma4_31b.log; }
...
log "===== Gemma-4-31B Sweep Started ====="

run_container "google/gemma-4-31B-it" 8192 && run_sweep "google/gemma-4-31B-it" "bf16"
run_container "RedHatAI/gemma-4-31B-it-FP8-block" 8192 && run_sweep "RedHatAI/gemma-4-31B-it-FP8-block" "fp8"
run_container "QuantTrio/gemma-4-31B-it-AWQ" 8192 && run_sweep "QuantTrio/gemma-4-31B-it-AWQ" "awq"
run_container "RedHatAI/gemma-4-31B-it-NVFP4" 8192 && run_sweep "RedHatAI/gemma-4-31B-it-NVFP4" "nvfp4"
