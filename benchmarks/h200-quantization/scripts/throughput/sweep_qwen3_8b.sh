#!/bin/bash
#SBATCH --job-name=qwen3_8b_sweep
...
log() { echo "[$(date '+%Y-%m-%d %H:%M:%S')] $1" | tee -a ~/quantization/results/throughput/logs/sweep_qwen3_8b.log; }
...
log "===== Qwen3-8B Sweep Started ====="

run_container "Qwen/Qwen3-8B"                8192 && run_sweep "Qwen/Qwen3-8B"                "bf16"
run_container "Qwen/Qwen3-8B-FP8"            8192 && run_sweep "Qwen/Qwen3-8B-FP8"            "fp8"
run_container "Qwen/Qwen3-8B-AWQ"            8192 && run_sweep "Qwen/Qwen3-8B-AWQ"            "awq"
run_container "JunHowie/Qwen3-8B-GPTQ-Int4"  8192 && run_sweep "JunHowie/Qwen3-8B-GPTQ-Int4"  "gptq"
