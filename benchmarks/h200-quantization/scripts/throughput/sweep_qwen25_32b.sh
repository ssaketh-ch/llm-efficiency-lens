#!/bin/bash
#SBATCH --job-name=qwen25_32b_sweep
...
log() { echo "[$(date '+%Y-%m-%d %H:%M:%S')] $1" | tee -a ~/quantization/results/throughput/logs/sweep_qwen25_32b.log; }
...
log "===== Qwen2.5-32B Sweep Started ====="

run_container "Qwen/Qwen2.5-32B-Instruct"                    8192 && run_sweep "Qwen/Qwen2.5-32B-Instruct"                    "bf16"
run_container "neuralmagic/Qwen2.5-32B-Instruct-FP8-Dynamic" 8192 && run_sweep "neuralmagic/Qwen2.5-32B-Instruct-FP8-Dynamic" "fp8"
run_container "Qwen/Qwen2.5-32B-Instruct-AWQ"                8192 && run_sweep "Qwen/Qwen2.5-32B-Instruct-AWQ"                "awq"
run_container "Qwen/Qwen2.5-32B-Instruct-GPTQ-Int4"          8192 && run_sweep "Qwen/Qwen2.5-32B-Instruct-GPTQ-Int4"          "gptq"
