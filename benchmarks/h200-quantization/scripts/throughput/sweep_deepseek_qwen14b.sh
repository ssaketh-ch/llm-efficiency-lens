#!/bin/bash
#SBATCH --job-name=deepseek_qwen14b_sweep
...
log() { echo "[$(date '+%Y-%m-%d %H:%M:%S')] $1" | tee -a ~/quantization/results/throughput/logs/sweep_deepseek_qwen14b.log; }
...
log "===== DeepSeek-R1-Distill-Qwen-14B Sweep Started ====="

run_container "deepseek-ai/DeepSeek-R1-Distill-Qwen-14B" 8192 && run_sweep "deepseek-ai/DeepSeek-R1-Distill-Qwen-14B" "bf16"
run_container "RedHatAI/DeepSeek-R1-Distill-Qwen-14B-FP8-dynamic" 8192 && run_sweep "RedHatAI/DeepSeek-R1-Distill-Qwen-14B-FP8-dynamic" "fp8"
run_container "Corianas/DeepSeek-R1-Distill-Qwen-14B-AWQ" 8192 && run_sweep "Corianas/DeepSeek-R1-Distill-Qwen-14B-AWQ" "awq"
run_container "RedHatAI/DeepSeek-R1-Distill-Qwen-14B-quantized.w4a16" 8192 && run_sweep "RedHatAI/DeepSeek-R1-Distill-Qwen-14B-quantized.w4a16" "gptq"
